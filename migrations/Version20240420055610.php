...
final class Version20240420055610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tasks (id INT NOT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, date_of_creation DATE NOT NULL, date_of_completing DATE NOT NULL, is_complete BOOLEAN NOT NULL, PRIMARY KEY(id))');
